...
{
	return ssh.execCommand('pm2 stop all && sudo service mongod stop', {cwd: '/home/ubuntu'});
}
...
{
	return ssh.execCommand('cd riot-express-todo-list && sudo service mongod start && pm2 start app.js', {cwd: '/home/ubuntu'});
}
